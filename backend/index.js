...
app.get("/new", function (req, res) {
  res.sendFile(path.join(__dirname, "../frontend/new-index.html"));
});

//express route
app.get("/load", function (req, res) {
  res.sendFile(path.join(__dirname, "../frontend/load.html"));
});

app.use('/img', serveIndex(path.join(__dirname, '../frontend/img'),  {icons: true, view: 'details'}) );
...
app.get("/newroom/:roomId", function (req, res) {
  ...
  //sending file
  res.sendFile(path.join(__dirname, "../frontend/new-game.html"));
});
